...
import 'package:m_store/featured/category/presentation/views/categories_screen.dart';
import 'package:m_store/featured/auth/presentation/views/login_screen.dart';
import 'package:m_store/featured/auth/presentation/views/splash_screen.dart';
import 'package:m_store/featured/products/data/presentation/views/newest_products.dart';
import 'package:m_store/featured/products/data/presentation/views/popular_products.dart';
...
class AppRoutes{
  ...
  static Route<dynamic> generateRoutes (RouteSettings routeSettings){
    ...
    switch(routeSettings.name){
      ...
      case details:
        if(arg is Product){
            return MaterialPageRoute(builder: (_)=>  ProductDetails(product:arg));
          }
          return _errorRoute();
      case categories:
         if(arg is List){
